...
if __name__ == "__main__":
    ...
    if get_purpose() == "demo":
        demo_users = []
        demo_users.append(create_user("demo-admin", email="", group="admin"))
        demo_users.append(create_user("demo-operator", email="", group="operator"))
        demo_users.append(create_user("demo-user", email="", group="user"))
        # print(demo_users)
